/*
 * 	File SquareServer.c
 *	A UDP server that receives a hyper XDR integer and echoes its square
...
int service (char *buf, int n, struct sockaddr_in *from, int s)
{
	...
	xdrhyper 	req;		/* request message */
	Response 	res;		/* response message */
	char	 	obuf[BUFLEN];	/* output buffer */
	unsigned int 	len;		/* length of output message */
